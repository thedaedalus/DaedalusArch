...
locale() {
    ...
    "
    options=("en_US.UTF-8" "en_AU.UTF-8" "en_GB.UTF-8" "exit")
    select_option "${options[@]}"

    case $? in
    0) export LOCALE="en_US.UTF-8";;
    1) export LOCALE="en_AU.UTF-8";;
    3) export LOCALE="en_GB.UTF-8";;
    4) exit ;;
    *) echo "Wrong option please select again"; locale;;
    esac
}
# Starting functions
background_checks
...
-------------------------------------------------------------------------
"
sudo pacman -S --noconfirm --needed sshd
